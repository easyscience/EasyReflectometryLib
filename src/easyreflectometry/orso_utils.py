...
def LoadOrso(orso_str: List[OrsoDataset]) -> Tuple[Sample, DataSet1D]:
...
def load_orso_model(orso_str: List[OrsoDataset]) -> Sample:
    """
...
def load_orso_data(orso_str: List[OrsoDataset]) -> DataSet1D:
    data = {}
    coords = {}
    attrs = {}
